...
/* Headers on every response. The CSP allows exactly what the page loads:
   our own files, the pinned CDN scripts + map data, Google Fonts, and the
   Cloudflare Web Analytics beacon (auto-injected on the hosted domain; it
   reports back to our own origin, so connect-src 'self' covers it). */
export const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': [
    "default-src 'none'",
    "script-src 'self' https://cdn.jsdelivr.net https://static.cloudflareinsights.com/beacon.min.js https://static.cloudflareinsights.com/beacon.min.js/",
